...
exports.register = catchAsync(async (req, res, next) => {
	const { email, password, passwordConfirm, name, phonenumber, role, isOrganizer } = req.body;
	if (!isOrganizer) {
		isOrganizer = false;
	}
	...
	const user = await User.create({ name, email, password, passwordConfirm, phonenumber, role, isOrganizer });
